...
describe(
  ...
  () => {
    it(
      "creates a user and verifies a matching password",
    ...
    it(
      "rejects a login for a username that does not exist",
    ...
    it(
      "reports whether a username already exists",
    ...
    it(
      "creates a session and resolves it back to the user",
    ...
    it(
      "returns undefined for an unknown session token",

      () => {
        const repository = new UserRepository(":memory:");

        expect(
          repository.getSession("not-a-real-token"),
        ).toBeUndefined();
      },
    );
    ...
    it(
      ...
      () => {
        ...
        expect(
          repository.getSession(session.token),
        ).toBeUndefined();
      },
    );

    it(
      "persists users after the repository is recreated",
