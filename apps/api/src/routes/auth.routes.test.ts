...
function createTestApp(
  ...
  app.register(
    createAuthRoutes(authService as never),
  );
...
describe(
  ...
  () => {
    it(
      "registers a user and sets a session cookie",
    ...
    it(
      "returns 403 when the username is not allowlisted",
    ...
    it(
      "logs in with valid credentials and sets a session cookie",
    ...
    it(
      "returns 401 for /auth/me with no session cookie",
